...
describe Rooble do
  ...
  context "#User John Example" do
    ...
    it "saves #user" do
      ...
      expect(john_example.savings.balance.cents).to eq 70000
    ...
    it "computes deposits and withdrawals" do
      ...
      expect(john_example.savings.balance.cents).to eq 100000

      john_example.checking.change_balance(-100)
      expect(john_example.checking.balance.cents).to eq 29900
    end
  end
end